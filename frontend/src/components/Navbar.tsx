    ...
    <>
      <nav
        ...
        style={{
          ...
          padding: scrolled ? '0.15rem 0' : '0.25rem 0 0.35rem 0',
        }}
      >
        <div className="navbar-container">
          ...
          <div className={`navbar-links ${isOpen ? 'active' : ''}`}>
            ...
            <Link to="/contacto" className={`navbar-link ${isActive('/contacto') ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
              Contacto
            </Link>
      ...
      {/* Spacer to maintain layout flow with fixed navbar */}
